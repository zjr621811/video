	...
	<div class="container">
		...
		<c:forEach items="${videoList}" var="video" >
			<div class="chapter">
				...
				<p class="lecturer">讲师：${video.s.speakerName}</p>
				<div class="v-info">
					<span class="count"><img src="./img/count.png" alt="">${video.videoPlayTimes}</span>
					<span class="duration"><img src="./img/player.png" alt="">${video.videoLength}</span>
				</div>
			</div>
		</c:forEach>
